...
#define __DATA_SIZE_IN_BITS__ (67+(SIZEOFUSERID<<3)) // works for 55?  -- (67 bits for 1024u45b) (91 for 4u60b) (101 for 4u65b)
...
#define __DATA_SIZE_IN_BYTES__ (9+SIZEOFUSERID) // default is 8 + ...
// 65 bits ??
